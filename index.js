...
module.exports = {
  rules: {
    ...
    // ---------------------------------------------
    'for-direction': 1, // eslint:recommended
    'getter-return': 2, // eslint:recommended
    'no-async-promise-executor': 1, // eslint:recommended
    'no-await-in-loop': 1,
    'no-compare-neg-zero': 2, // eslint:recommended
    'no-cond-assign': 1, // eslint:recommended
    // 'no-console': 2,
    'no-constant-condition': [2, { 'checkLoops': false }], // eslint:recommended
    ...
    'no-empty': [2, { allowEmptyCatch: true }], // eslint:recommended
    ...
    'no-irregular-whitespace': [2, {'skipStrings': true, 'skipComments': true, 'skipRegExps': true, 'skipTemplates': true } ], // eslint:recommended
    ...
    // 'no-unsafe-negation': 0, // eslint:recommended
    ...
    'no-global-assign': 0, // eslint:recommended
    ...
    'no-useless-call': 0, // eslint:recommended
    // 'no-useless-catch': 0,
    // 'no-useless-concat': 0,
    ...
    // ---------------------------------------
    // 'init-declarations': 0,
    // 'no-delete-var': 0, // eslint:recommended
    // 'no-label-var': 0,
    ...
    // 'id-length': 0,
    // 'id-match': 0,
    // 'implicit-arrow-linebreak': 0, // automatically fix
    'indent': [
      2, 2, {
        'CallExpression': {
          'arguments': 2,
